...
public class HualienThread extends Thread {

    public void run(){
        try {
            //HttpURLConnection
            //最高溫
            String url = "https://opendata.cwb.gov.tw/api/v1/rest/datastore/F-D0047-043?Authorization=CWB-8DC6CA43-0E15-41F6-942A-DF486DD93867&elementName=MaxT";
            ...
            JSONObject s4 = s3.getJSONObject(5);
            ...
            //MinT
            String url1 = "https://opendata.cwb.gov.tw/api/v1/rest/datastore/F-D0047-043?Authorization=CWB-8DC6CA43-0E15-41F6-942A-DF486DD93867&elementName=MinT";
            ...
            JSONObject sB4 = sB3.getJSONObject(5);
            ...
            //Wx
            String url2 = "https://opendata.cwb.gov.tw/api/v1/rest/datastore/F-D0047-043?Authorization=CWB-8DC6CA43-0E15-41F6-942A-DF486DD93867&elementName=Wx";
            ...
            JSONObject sC4 = sC3.getJSONObject(5);
            ...
            msg.setData(carrier);
            Hualien.mHandler.sendMessage(msg);
        }catch (Exception e){
            e.printStackTrace();
        }
    }
